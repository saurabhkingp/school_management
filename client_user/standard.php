                  ...
                  <tr> 
                    <td > 
                     <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#E2F0FE"> 
                        <tr> 
                          <td valign="middle" colspan="4"  background="images/header.gif"class=title><img src="images/decoration_head.png" align="absmiddle">&nbsp;&nbsp;Course&nbsp;&nbsp;<img src="images/decoration_head.png" align="absmiddle"></td> 
                        </tr> 
                      </table> 
                        ...
                        <tr> 
                          <td height="135" >
							...
							<td colspan="3">&nbsp;</td>
								...
								<tr> 								
                              <td class="path">Course </td> 
                              <td class="path">Duration </td> 
							...
							?>
                             ...
                             <tr align="center" class="gbg"> 
							  ...
							  <td><div align="center"> <font face="verdana" style="font-size:15px"><?php echo($row['standard_name']); ?></font></div></td> 
                              <td><font face="verdana" style="font-size:15px"><?php echo($row['intake']); ?></font></td> 
             
                              <td><font face="verdana" style="font-size:15px"><?php echo($row['fees']); ?></font> </td> 
			               </td>
							</tr> 
