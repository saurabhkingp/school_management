...
<table width="160" border="0" cellspacing="0" cellpadding="0">  <tr> 
                  ...
                  <tr> 
                    <td bgcolor="#E2F0FE"> 
                      ...
                      <table width="100%" cellpadding="0" cellspacing="0"> 
                        ...
                        <tr> 
						<td width="2%">&nbsp;</td>
                          <td height="150"class="maintaxt"><ul> 
                                  <li class="style1"> 
  ...
  <tr> 
    <td height="26" align="center" valign="bottom">&copy; VIRENDRA SWAROOP INSTITUTE OF COMPUTER STUDIES, <?php echo date("M,Y");?></td>
	</tr> 
