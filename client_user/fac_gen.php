                        ...
                        <tr> 
                          <td height="135">
						  	<table width="93%" align="center" cellpadding="3" cellspacing="2"> 
								<tr> 
                              <td width="27%" class="path">Faculty_Name </td> 
                            ...
                            <tr align="center" class="gbg"> 
							  ...
							  <td>+91<?php echo($row['contact']); ?></td> 												  										                              <td><a href="mailto:<?php echo($row['email']);?>"><?php echo($row['email']); ?></a></td>
...
<tr> 
    <td height="26" align="center" valign="bottom"><div align="center">&copy; VIRENDRA SWAROOP INSTITUTE OF COMPUTER STUDIES </div></td>
	</tr> 
</table> 
