...
$conn = mysqli_connect($dbServername, $dbUsername, $dbPassword, $dbName );
	$sql= "INSERT INTO admission 
			VALUES('$[id]','$_POST[name]','$_POST[standard]')" ;
$result = mysqli_query($conn, $sql);
echo '<font face="verdana"  size=5px color="#336666">';
echo '<u>';
echo '</u>'; 
...
<script language="javascript" src="javascript/add_admission.js"></script>
  ...
  <tr class="lgbg">
    <td width="286"  align="right" class="fheader"><font style="font-size:15px"><b>Name</b></font> </td>
    <td width="6" class="formfontcaps"><font face="Arial" size="+1">:</font></td>
    <td width="390"><input  type="text"  name="name" size="50" /></td>
  </tr>
 <tr class="lgbg">
    <td width="286"  align="right" class="fheader"><font style="font-size:15px"><b>Course</b></font> </td>
    <td width="6" class="formfontcaps"><font face="Arial" size="+1">:</font></td>
