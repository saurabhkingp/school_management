...
?>						
    							...
    							<tr align="center">
 								...
 								<td></td>
								<input class="textbox1" type="hidden" name="id" value="<?php echo($row['id']); ?>">
			<td bgcolor="#DDDDDD"><input type="Text" class="textbox1" name="standard_name" size="35" value="<?php echo($row['standard_name']); ?>">							  </td> 
                              <td bgcolor="#DDDDDD"><input type="Text" class="textbox1" name="intake"  size="5"value="<?php echo($row['intake']); ?>"></td> 
                              
                              <td bgcolor="#DDDDDD"><input type="Text" class="textbox1" name="fees" size="15" value="<?php echo($row['fees']); ?>"> </td>
